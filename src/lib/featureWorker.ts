...
const featureWorker: FeatureWorkerInterface = {
   ...
   * @param imageData 圖像數據
   */
  private async calculateAverageHash(imageData: ImageData): Promise<string> {
    // 縮小圖像為 8x8
   ...
   * @param imageData 圖像數據
   */
  private async calculateDifferenceHash(imageData: ImageData): Promise<string> {
   ...
   * @param height 高度
   */
  private performDCT(grayValues: number[], width: number, height: number): number[] {
